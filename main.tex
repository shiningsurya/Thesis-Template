...
\Acknowledgments{%
	This work would not be what it is if not for the guidance and patience offered by Dr. Matthew Kerr.
	I am ever grateful to Dr. Matthew for that.
...
\BiographicalSketch{%
	...
	\emph{email: shining.surya.d8@gmail.com}
}
...
\newcommand{\vlite}{\texttt{VLITE}}
\newcommand{\vla}{\texttt{VLA}}
\newcommand{\vfps}{\texttt{VFPS}}
\newcommand{\root}{\texttt{ROOT}}
\newcommand{\mjd}{\texttt{MJD}}
...
\newcommand{\float}{\texttt{float32}}
\newcommand{\cc}{\emph{C}}
\newcommand{\sn}{S/N{}}
\newcommand{\sd}{std.~dev.}
\newcommand{\psr}[1]{\textt{PSR\"#1}}
\newcommand{\DM}[1]{\textt{DM=#1~pc/cc}}
\newcommand{\nchan}[1]{\textt{NCHAN=#1}}
\newcommand{\nbit}[1]{\textt{NBIT#1}}
